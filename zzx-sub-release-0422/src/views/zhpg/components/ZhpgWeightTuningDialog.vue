...
defineEmits(['run-objective-weight'])
...
.zhpg-weight-tuning-dialog.el-dialog {
  ...
  --wtl-sum-bg: var(--el-fill-color-light);
  --wtl-sum-border: var(--el-border-color-lighter);
  --wtl-sum-text: var(--el-text-color-regular);
  --wtl-input-bg: var(--el-fill-color-blank);
  --wtl-input-border: var(--el-border-color);
  --wtl-input-border-focus: var(--el-color-primary);
  --wtl-input-text: var(--el-text-color-primary);
  --wtl-control-bg: var(--el-fill-color-light);
  --wtl-control-text: var(--el-text-color-secondary);
...
.zhpg-weight-tuning-dialog .wtl-sum-line {
  background: var(--wtl-sum-bg);
  border: 1px solid var(--wtl-sum-border);
  color: var(--wtl-sum-text);
}
...
.zhpg-weight-tuning-dialog .el-input-number .el-input__wrapper {
  background-color: var(--wtl-input-bg);
  border: 1px solid var(--wtl-input-border);
  box-shadow: none;
}
...
.zhpg-weight-tuning-dialog .el-input-number .el-input__wrapper:hover {
  border-color: var(--wtl-input-border-focus);
  box-shadow: 0 0 0 1px var(--wtl-input-border-focus);
}

.zhpg-weight-tuning-dialog .el-input-number .el-input__inner {
  color: var(--wtl-input-text);
}

.zhpg-weight-tuning-dialog .el-input-number__increase,
.zhpg-weight-tuning-dialog .el-input-number__decrease {
  background-color: var(--wtl-control-bg);
  border-color: var(--wtl-input-border);
  color: var(--wtl-control-text);
}
...
.dark-theme .zhpg-weight-tuning-dialog {
  ...
  --wtl-sum-bg: rgba(15, 23, 42, 0.86);
  --wtl-sum-border: rgba(0, 242, 255, 0.16);
  --wtl-sum-text: #9fb6cb;
  --wtl-input-bg: rgba(5, 13, 24, 0.74);
  --wtl-input-border: rgba(0, 242, 255, 0.2);
  --wtl-input-border-focus: #38bdf8;
  --wtl-input-text: #d8e7f5;
  --wtl-control-bg: rgba(5, 13, 24, 0.92);
  --wtl-control-text: #9fb6cb;
  color: #d8e7f5;
}
</style>

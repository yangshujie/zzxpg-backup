<template>
  <div class="app-container">
    ...
    <el-dialog v-model="previewVisible" :title="previewTitle" width="960px" append-to-body destroy-on-close class="algo-preview-dialog">
      <pre class="algo-preview-pre"><code class="algo-preview-code" v-html="previewHighlightedHtml"></code></pre>
    </el-dialog>
  </div>
</template>
...
const previewHighlightedHtml = computed(() => {
  ...
  return highlightSourceCode(code, previewTitle.value);
});
...
// 预览弹窗：覆盖全局 dialog 的半透明背景，使用不透明深色，避免穿透看到下层页面

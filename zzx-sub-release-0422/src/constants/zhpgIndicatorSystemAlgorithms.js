...
/** 存库 / 接口：{"id":"101", "params": {}} */
export function serializeWeightAssignConfig(id, params) {
  if (!id) return ''
  return JSON.stringify({ id: String(id), params: params || {} })
}

export function parseWeightAssignConfig(jsonStr) {
  if (!jsonStr || !String(jsonStr).trim()) return { id: '', params: {} }
  try {
    const o = JSON.parse(jsonStr)
    if (typeof o === 'string') return { id: o, params: {} }
    return { id: String(o.id || ''), params: o.params || {} }
  } catch {
    return { id: '', params: {} }
  }
}

...
import { listIndicatorSystem, getIndicatorSystem, delIndicatorSystem, addIndicatorSystem, updateIndicatorSystem, autoOptimizeWeight } from '@/api/capabilityResource/indicatorSystem'

...
/* 滚动条样式 */
.env-form-list::-webkit-scrollbar {
  width: 6px;
}

.env-form-list::-webkit-scrollbar-track {
  background: var(--el-bg-color-page);
  border-radius: 3px;
}

.env-form-list::-webkit-scrollbar-thumb {
  background: var(--el-border-color-dark);
  border-radius: 3px;
}

.env-form-list::-webkit-scrollbar-thumb:hover {
...
.coords-list::-webkit-scrollbar-track {
  background: var(--el-bg-color-page);
  border-radius: 2px;
}

.coords-list::-webkit-scrollbar-thumb {
  background: var(--el-border-color-dark);
  border-radius: 2px;
}

.coords-list::-webkit-scrollbar-thumb:hover {
  background: var(--el-border-color-darker);
}
</style>
  ...
  <div class="indicator-system-editor">
    ...
    <div class="tree-sidebar">
      <div class="sidebar-head">
        ...
        <el-icon class="op-icon" title="添加根节点" @click="addRootChild">
          <CirclePlus />
        </el-icon>
      </div>
      <div class="sidebar-content">
        <el-tree ref="treeRef" :data="treeData" node-key="id" default-expand-all :expand-on-click-node="false" draggable
    ...
    <div class="library-sidebar" :class="{ collapsed: libCollapsed }">
      <div class="sidebar-head">
...
.indicator-system-editor {
  ...
  .visual-canvas {
    ...
    .svg-wrap {
      ...
      background-image: radial-gradient(#21282f 1px, transparent 1px);
...
:deep(svg) {
  ...
  .tree-node-group {
    ...
    &.is-drop-target .node-rect {
      stroke: #3fb950;
      stroke-width: 2px;
      filter: drop-shadow(0 0 6px #3fb950);
    }

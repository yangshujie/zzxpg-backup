        ...
        <main class="main-content">
            ...
            <div class="req-table-container" v-loading="loading" element-loading-background="rgba(13, 17, 23, 0.8)">
                <el-table v-if="filteredRequirements.length > 0" :data="filteredRequirements" style="width: 100%"
                    ...
                    <el-table-column width="70" align="center" type="index">
                    </el-table-column>
...
.requirement-management {
    display: flex;
    height: calc(100vh - 70px); // subtract TopNavLayout header height
    background: #0d1117;
    color: #e6edf3;
    overflow: hidden;
    position: relative;
...
.tech-table {
    ...
    --el-table-header-bg-color: rgba(22, 27, 34, 0.8);
    --el-table-header-text-color: #7d8590;
    --el-table-row-hover-bg-color: rgba(255, 107, 53, 0.05);
